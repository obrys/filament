...
export const api = {
    ...
    spools: {
        ...
        open: (id) => http(`/api/spools/${id}/open`, { method: 'POST' }),
        finish: (id) => http(`/api/spools/${id}/finish`, { method: 'POST' }),
        ...
        enableEvent: (id, eventId) => http(`/api/spools/${id}/events/${eventId}/enable`, { method: 'POST' }),
        disableEvent: (id, eventId) => http(`/api/spools/${id}/events/${eventId}/disable`, { method: 'POST' }),
        reevaluate: () => http('/api/spools/reevaluate', { method: 'POST' }),
